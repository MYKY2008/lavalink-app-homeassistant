...
bashio::log.info "=== Lavalink Addon v2.1.1 ==="
...
YT_CLIENTS=$(bashio::config 'youtube_clients' 'MUSIC,ANDROID_MUSIC,ANDROID,ANDROID_VR,WEBEMBEDDED,MWEB,IOS,TVHTML5_SIMPLY')
